...
export const validateRequest = (email:string, token:string, from:string, to:string) => {
    switch (true) {
        case !email:
        ...
        case !validateDate(to):
        case !validateDate(from):
...
export const validateResponse = (compraNode:Document, ventaNode:Document) => {
